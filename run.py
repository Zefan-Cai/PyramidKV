...
def main(args):
    ...
    input_max_len = 0
    model_max_len = model2maxlen[args.model_name]
    ...
    os.makedirs(os.path.join(args.base_dir, args.save_dir, args.model_name, args.dataset), exist_ok=True)

    fout = open(os.path.join(args.base_dir, args.save_dir, args.model_name, args.dataset, f"{args.method}.json"), "w")
...
if __name__ == "__main__":
    ...
    args.model_name_or_path = os.path.join(args.base_dir, "ckpt", args.model_name)
    ...
    for idx, dataset in enumerate(datasets):
        ...
        args.data_file = os.path.join(args.base_dir, "data", "LongBench", "data", f"{args.dataset}.jsonl")
