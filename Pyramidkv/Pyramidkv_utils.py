...
class PyramidKVCluster():
    ...
    def update_kv(self, key_states, query_states, value_states, attention_mask, num_key_value_groups):
        ...
        # print(f"debug self.layer_idx {self.layer_idx}")
        # print(f"debug steps {q_len}")
        # print(f"debug steps {steps}")
        # print(f"debug min_num {min_num}")
        # print(f"debug max_num {max_num}")
